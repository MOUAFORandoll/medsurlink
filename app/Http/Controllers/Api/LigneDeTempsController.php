       ...
       /*  $examen_validation_assureur = ConsultationExamenValidation::with(['consultation.ligneDeTemps.motif:id,description','consultation.dossier.patient.user','consultation.author'])->whereHas('consultation.dossier', function($query) use($patient) {
        ...
        foreach($affiliations as $affiliation){
            if($affiliation->souscripteur){
                ...
                $newAffiliation->bornAroundAffilie = $affiliation->patient ? $affiliation->patient->date_de_naissance : "";
                $newAffiliation->bornAroundSouscripteur = $affiliation->souscripteur ? $affiliation->souscripteur->date_de_naissance : "";;
                ...
                $newAffiliation->dateNaissanceAffilie = $affiliation->patient ? $affiliation->patient->date_de_naissance: "";
                $newAffiliation->dateNaissanceSouscripteur = $affiliation->souscripteur ? $affiliation->souscripteur->date_de_naissance : "";
