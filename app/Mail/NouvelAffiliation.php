...
class NouvelAffiliation extends Mailable
{
    ...
    public $patient_nom, $patient_prenom, $patient_telehone, $plaintes, $niveau_urgence, $contact_nom, $contact_prenom, $contact_phone, $typeSouscription, $paye_par_affilie, $souscripteur, $affiliation, $urgence;
    /**
     * Create a new message instance.
     *
     * @return void
     */
    public function __construct($patient_nom, $patient_prenom, $patient_telehone, $plaintes, $niveau_urgence, $contact_nom, $contact_prenom, $contact_phone, $typeSouscription, $paye_par_affilie, $souscripteur, $affiliation, $urgence)
    {
