...
class CreateResultatImageriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('resultat_imageries', function (Blueprint $table) {
        ...
        Schema::table('resultat_imageries', function(Blueprint $table) {
    ...
    {
        Schema::dropIfExists('resultat_imageries');
    }
}
