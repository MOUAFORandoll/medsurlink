...
<body>
    <div style="position:absolute;">
        ...
        {{-- <div style="position:absolute;left:150px;top:206.25px;width: 17.5%; height: 63px; border:1px solid #00ada7; background-color: #00ada7;">
        <div style="position:relative; width: 100%" class="cls_011"><span class="cls_011">Échéance</span></div>
        <div style="position:relative:left: 10px; top:15px; " class="cls_008"><span class="cls_008">{{ $echeance }}</span>
    </div>
    </div> --}}
    ...
    <div style="position:absolute;left:250px;top:150px;width: 63.8%; height: 130px; border:1px solid #00ada7;">
        ...
        {{--
        <div style="position: relative;left: 10px;top:2px" class="cls_004"><span class="cls_004">Bénéficiaire : {{ $beneficiaire }}</span>
    </div>
        ...
        <table style="width: 100%;">
            ...
            <tbody>
                <tr class="produit">
                    ...
                    <td class="center">{{ $prix_unitaire }}</td>
                    <td class="center">{{ $montant_total }}</td>
                </tr>
            </tbody>
        </table>
        <br><br><br><br>
    ...
    <div style="position:absolute;left:390px;top:815px;width: 40%; height: 170px; border:1px solid #00ada7; background-color: #00ada7;">
        <div style="position:relative; width: 100%" class="cls_011"><span class="cls_011">Total payé</span></div>
        <div style="position:relative;left:10px;top:20px; width:" class="cls_012"><span class="cls_012">{{ $montant_total }} &euro;</span></div>
    </div>
