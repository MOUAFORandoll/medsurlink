...
<div style="position:absolute;">
            ...
            <tbody>
                @forelse ($examen_validations as $item)
                    <tr class="produit">
                        ...
                        <td class="center">{{ $item->etat_validation_medecin }}</td>
                        <td class="center">{{ $item->etat_validation_souscripteur }}</td>
                    </tr>
                @empty
                @endforelse
                <tfoot>
                    <tr>
                        <td class="">Total</td>
                        <td class="center">{{ $total_prescription }}</td>
                        <td class="center">{{ $total_medecin_controle }}</td>
                        <td class="center">{{ $total_medecin_assureur }}</td>
                    </tr>
                </tfoot>
            </tbody>
        </table>
   ...
   {{--  <div style="position:absolute;left:20px;top:815px;width: 50%; height: 170px; border:1px solid #00ada7;">
    ...
    <div style="position:absolute;left:390px;top:815px;width: 40%; height: 170px; border:1px solid #00ada7; background-color: #00ada7;">
        <div style="position:relative; width: 100%" class="cls_011"><span class="cls_011">Total payé</span></div>
        <div style="position:relative;left:10px;top:20px; width:" class="cls_012"><span class="cls_012">255 XAF</span></div>
    </div>
